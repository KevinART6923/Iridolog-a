...
contacto.addEventListener('click', (e) => {
    ...
    Swal.fire({
      ...
      <div class='modal-items'>
        <i class="fas fa-phone-alt"></i> <h3> Teléfono Colombia</h3><br>
        </div>
        <p class='modal-p'>+57 313 3997518</p>

      <br>
      <div  class='modal-items'>
        <i class="fas fa-phone-alt"></i> <h3>Teléfono California</h3><br>
        </div>
        <p class='modal-p'>+1 (951) 571-5934</p>

      <br>
      <div  class='modal-items'>
        <i class="fas fa-envelope"></i> <h3>Correo Electrónico</h3><br>
        </div>
...
info.addEventListener('click', (e) => {
    ...
    if (window.innerWidth <= 500) {
        ...
        textToShow = `Somos parte de las 5 Diviones del grupo de compañías <a href='https://evgroup.org' target="_blank">EVGROUP</a> <br>  
